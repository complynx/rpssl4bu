...
import (
	...
	pkg "github.com/complynx/rpssl4bu/pkg"
...
func (_m *Game) Choice(_a0 context.Context) (pkg.Choice, error) {
	ret := _m.Called(_a0)

	var r0 pkg.Choice
	if rf, ok := ret.Get(0).(func(context.Context) pkg.Choice); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(pkg.Choice)
	}
...
func (_c *Game_Choice_Call) Return(_a0 pkg.Choice, _a1 error) *Game_Choice_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

// Choices provides a mock function with given fields: _a0
func (_m *Game) Choices(_a0 context.Context) ([]pkg.Choice, error) {
	ret := _m.Called(_a0)
...
func (_c *Game_Choices_Call) Return(_a0 []pkg.Choice, _a1 error) *Game_Choices_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

// Play provides a mock function with given fields: _a0, _a1
func (_m *Game) Play(_a0 context.Context, _a1 int) (string, pkg.Choice, error) {
	...
	var r1 pkg.Choice
	if rf, ok := ret.Get(1).(func(context.Context, int) pkg.Choice); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Get(1).(pkg.Choice)
	}
...
func (_c *Game_Play_Call) Run(run func(_a0 context.Context, _a1 int)) *Game_Play_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Game_Play_Call) Return(_a0 string, _a1 pkg.Choice, _a2 error) *Game_Play_Call {
